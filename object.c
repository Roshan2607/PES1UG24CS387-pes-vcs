...
int object_write(ObjectType type, const void *data, size_t len, ObjectID *id_out) {
    // Step 1: Determine type string from the ObjectType enum
    const char *type_str;
    switch (type) {
